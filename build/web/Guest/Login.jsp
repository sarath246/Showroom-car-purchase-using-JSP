...
<body>
   ...
   <%
            String uname="",psw="",select="",inserts="",status="";
            int k=1;
            int m=2;
            String stus=String.valueOf(m);
        ...
        ResultSet rss=obj.selectCommand(select);
         ...
         if(rss.next())
        {
           status=rss.getString("showroom_status");
        ...
        else if(rss.next())
        {
           ...
           // String statuss=rss.getString("showroom_status");
            //System.out.println(status);
        }else if(status.equals(stus)){
            out.println("<script>alert('Admin was rejected')</script>");
            System.out.println("Admin was rejected");
        }
        else
        {
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-md-4 col-sm-4 col-xs-12">
                <div class="text-center m-b-md custom-login">
                    <h3 style="color: white;">PLEASE LOGIN TO APP</h3>
                </div><br/><br/>
                <div class="hpanel">
                    <div class="panel-body">
                        <form action="#" id="loginForm">
                            <div class="form-group">
                                ...
                                <input type="text" name="txt_uname" placeholder="example@gmail.com" title="Please enter you username" required="" value="" name="username" id="username" class="form-control">
                                <span class="help-block small">Your unique username to app</span>
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="password">Password</label>
                                <input type="password" name="txt_psw" title="Please enter your password" placeholder="******" required="" value="" name="password" id="password" class="form-control">
                            ...
                            <input type="submit" name="btn_submit" class="btn btn-success btn-block loginbtn" value="Login">
                            <button class="btn btn-default btn-block" id="myBtn">Register</button>
    ...
    <p>Some text in the Modal..</p>
        ...
        <div class="row">
            <div class="col-md-12 col-md-12 col-sm-12 col-xs-12 text-center">
                <p style="color: white;">Copyright © 2020 <a href="../Guest/index.html">Spices</a> All rights reserved.</p>
            </div>
        </div>
    </div>
