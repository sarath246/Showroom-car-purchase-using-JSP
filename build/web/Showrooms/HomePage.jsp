        ...
        <nav id="sidebar" class="">
			...
			<div class="nalika-profile">
				<div class="profile-dtl">
					...
					<h2>Showroom <span class="min-dtn"></span></h2>
				</div>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="ShowroomSpareParts.jsp"><span class="mini-sub-pro">Spare parts</span></a></li>
                                <li><a title="Dashboard v.2" href="Showroom_cars.jsp"><span class="mini-sub-pro">Cars</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="Index.html" aria-expanded="false"><i class="icon nalika-mail icon-wrap"></i> <span class="mini-click-non">Delivery List</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Inbox" href="Delivery_list.jsp"><span class="mini-sub-pro">Delivered List</span></a></li>
                                <li><a title="View Mail" href="Replayed_users.jsp"><span class="mini-sub-pro">Replayed List</span></a></li>
                                <li><a title="Compose Mail" href="#"><span class="mini-sub-pro">Service List</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="Index.html" aria-expanded="false"><i class="icon nalika-diamond icon-wrap"></i> <span class="mini-click-non">Bookings</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Google Map" href="User_car_purchase_show.jsp"><span class="mini-sub-pro">Cars</span></a></li>
                                <li><a title="Data Maps" href="Spare_Parts_orders_users.jsp"><span class="mini-sub-pro">Spare Parts</span></a></li>
                                <li><a title="Pdf Viewer" href="Service_bookings_users.jsp"><span class="mini-sub-pro">Service Books</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="Index.html" aria-expanded="false"><i class="icon nalika-diamond icon-wrap"></i> <span class="mini-click-non">Order</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Google Map" href="Company_products.jsp"><span class="mini-sub-pro">Cars</span></a></li>
                                <li><a title="Data Maps" href="Spare_Parts_orders_users.jsp"><span class="mini-sub-pro">Spare Parts</span></a></li>
                            </ul>
                        </li>
                        <li>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <li><a href="Myprofile.jsp"><span class="icon nalika-user author-log-ic"></span> My Profile</a>
                                                        </li>
                                                         <li><a href="Editprofile.jsp"><span class="icon nalika-home author-log-ic"></span>Edit profile</a>
                                                        </li>
                                                        <li><a href="Change_psw.jsp"><span class="icon nalika-diamond author-log-ic"></span> Change password</a>
                                                        </li>
                                                        <li><a href="#"><span class="icon nalika-settings author-log-ic"></span> Settings</a>
                                                        </li>
                                                        <li><a href="../Guest/index.html?lid=<%= session.getAttribute("regid") %>" ><span class="icon nalika-unlocked author-log-ic"></span>Logout</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
                                                                                            <h2> <a href="HomePage.jsp">Dashboard One</a></h2>
