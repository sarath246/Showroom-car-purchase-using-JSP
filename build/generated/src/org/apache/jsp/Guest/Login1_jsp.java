  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("   ");
            ...
            String uname="",psw="",select="";
            uname=request.getParameter("txt_uname");
            psw=request.getParameter("txt_psw");
            
        String sel="select * from tbl_company where company_uname='"+uname+"' and company_psw='"+psw+"'";
        ResultSet rs=obj.selectCommand(sel);
        
        select="select * from tbl_showroom where showroom_uname='"+uname+"' and showroom_psw='"+psw+"'";
        ...
        }else if(rss.next())
        {
            ...
            response.sendRedirect("../Showrooms/ShowroomHome.jsp");
        } else
        {
      ...
      out.write("                            <a class=\"btn btn-default btn-block\" href=\"#\">Register</a>\n");
      out.write("                        </form>\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
