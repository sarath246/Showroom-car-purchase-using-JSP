...
<body>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class=""><br/><br/>
            <div class="sidebar-header">
                <a href="#"><h2>Spices</h2></a>
			...
			<div class="nalika-profile">
				<div class="profile-dtl">
					...
					<h2>
                                            ...
                                            <%
                                                String u="",uname="";
                                                u=String.valueOf(session.getAttribute("uname"));
                                                //unames=String.valueOf(u);
                                                uname=u.toUpperCase();
                                                %>
    <br/>
    <span class="min-dtn" title="Company : <% out.println(uname); %>"><% out.println(uname); %></span></h2>
...
.zoom:hover {
  ...
  transform: scale(1.5); 
				...
				<div class="profile-social-dtl">
					<ul class="dtl-social">
                                            <li class="zoom" title="Facebook"><a href="#"><i class="icon nalika-facebook" ></i></a></li>
                                            <li class="zoom" title="Twitter"><a href="#"><i class="icon nalika-twitter"></i></a></li>
                                            <li class="zoom" title="Linkedin"><a href="#"><i class="icon nalika-linkedin"></i></a></li>
					</ul>
				</div>
			</div>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="Car_details.jsp"><span class="mini-sub-pro">Car Details</span></a></li>
                                <li><a title="Dashboard v.2" href="Car_gallary.jsp"><span class="mini-sub-pro">Car gallary</span></a></li>
                                <li><a title="Dashboard v.3" href="Car_transmission.jsp"> <span class="mini-sub-pro">Transmission</span></a></li>
                                <li><a title="Product List" href="SpareParts_gallary.jsp"><span class="mini-sub-pro">Spare parts gallary</span></a></li>
                                <li><a title="Product Edit" href="Spareparts_details.jsp"><span class="mini-sub-pro">Spare parts details</span></a></li>
                                ...
                                <li><a title="Analytics" href="Advertisement.jsp"><span class="mini-sub-pro">Advertisement</span></a></li>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        <li><a href="#"><span class="icon nalika-home author-log-ic"></span>My Gallery</a>
                                                        </li>
                                                        ...
                                                        <li><a href="../Guest/index.html"><span class="icon nalika-unlocked author-log-ic"></span> Log Out</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											<div class="breadcomb-icon">
                                                                                            <a href="HomePage.jsp"><i class="icon nalika-home" title="Refresh"></i></a>
											</div>
